...
def mc_analysis(result_dates: Series, result_amounts: Series, start_equity: float,
    ...
    sim = run_simulation(nb_iterations, nb_trades_for_sample, result_amounts, start_equity, ruin_equity)

    return get_simulation_results(sim, start_equity)


def run_simulation(nb_iterations: int, nb_trades_for_sample: int, result_amounts: Series, start_equity: float,
